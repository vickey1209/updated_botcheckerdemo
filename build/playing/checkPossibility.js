...
const checkPOssibility = (data, socket) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        data = yield (0, requestValidation_1.checkPossibilityValidation)(data);
        if (data) {
            ...
            if (tableData) {
                ...
                // king
                    ...
                    // 4 kill
                    else if (color == diceColor && (D == KillColor || D == killColorKing) &&
                        KD == 0) {
                        possibilityData.data.killRow = [row + 2];
                        possibilityData.data.killCol = [col - 2];
                        possibilityData.data.kill = [[row + 1, col - 1]];
                ...
                let validatePossibilityData = yield (0, responseValidation_1.resPossibilityValidation)(possibilityData);
                validatePossibilityData
                    ? eventEmitter_1.default.sendToRoom(tableData._id, validatePossibilityData)
                    : null;
            }
        }
    }
